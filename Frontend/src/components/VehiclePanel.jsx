...
const VehiclePanel = (props) => {
  return (
    <div> <h5 className='p-1 text-center w-[93%] absolute top-0 ' onClick={()=>{
        ...
        }} className='flex border-2 active:border-black bg-gray rounded-xl mb-2 w-full item-center justify-between'>
              <img className='h-12' src='https://www.pngplay.com/wp-content/uploads/8/Uber-PNG-Photos.png'/>
              <div className='ml-2 w-1/2'>
                <h4 className='font-medium text-sm'>Cab Economy <span><i className='ri-user-3-fill'></i>4</span></h4>
                <h5 className='font-medium text-sm'>2 min away</h5>
                <p className='font-medium text-xs text-grey-600'>Affordable Compact Rides</p>
              </div>
              <h2 className='text-lg font-semibold'>₹199.99</h2>
        </div>
        <div  onClick={()=> {
            props.setConfirmRidePanel(true)
        }}  className='flex border-2 active:border-black bg-gray rounded-xl mb-2 w-full item-center justify-between'>
              ...
              <div className='ml-2 w-1/2'>
                <h4 className='font-medium text-sm'>Bike <span><i className='ri-user-3-fill'></i>2</span></h4>
                <h5 className='font-medium text-sm'>5 min away</h5>
                <p className='font-medium text-xs text-grey-600'>Affordable Compact Rides</p>
              </div>
              <h2 className='text-lg font-semibold'>₹69.99</h2>
        </div>
        <div  onClick={()=> {
            props.setConfirmRidePanel(true)
        }}  className='flex border-2 active:border-black bg-gray rounded-xl mb-2 w-full item-center justify-between'>
              ...
              <div className='ml-2 w-1/2'>
                <h4 className='font-medium text-sm'>Auto <span><i className='ri-user-3-fill'></i>2</span></h4>
                <h5 className='font-medium text-sm'>3 min away</h5>
                <p className='font-medium text-xs text-grey-600'>Affordable Rides</p>
              </div>
              <h2 className='text-lg font-semibold'>₹99.99</h2>
        </div></div>
  )
}
