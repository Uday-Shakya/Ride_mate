...
const RidePopUp = (props) => {
  return (
    <div>
       ...
       }} className=' mt-1 bg-gray-400 text-gray-700 font-semibold px-10 p-3 rounded-lg'> Igrone </button>

       <button onClick={()=>{
        props.setConfirmRidePopupPanel(true)
        props.confirmRide()
        
       }} className='  bg-green-600 text-white font-semibold px-10 p-3 rounded-lg'> Accept </button>
